...
module.exports = {
  ...
  // setBudget: function(budget){ //sets the current budget to amount on current user
  ...
  // addBalanceToArchive: function(){ //capture previous balance, new balance ( and net amount added // no use for now )
  //   // not needed for now
  // },
